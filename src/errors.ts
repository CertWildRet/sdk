/**
 * DiamondError code ⇄ name/message map, built from the IDL's error table (116 codes as of
 * abi@fbf5890 — the table is read from the IDL at runtime, so new codes need no edit here),
